...
import { updateIsVisible, updateFlagType, updateFlagStartDate, updateFlagEndDate, updateFlag } from './actions';
...
class FlagCreate extends React.Component {
  ...
  handleFormSubmit(e) {
    ...
    this.context.store.dispatch(updateFlag(reducer.flag));
  }
...
function mapStateToProps(state) {
  return {
    reducer: state.flagUpdateReducer
  };
}
